...
const LayoutButton2 = ({ activeLayout }) => {
    return (
        <div className='rounded-lg cursor-pointer'>
            {activeLayout === 2 ?
                <div className='flex items-center gap-x-2'>
                    <div className='bg-secondary w-full h-16 text-center text-xl font-medium flex items-center justify-center text-primary rounded-md'>SELECTED</div>
                    <div className='bg-secondary w-full h-16 text-center text-xl font-medium flex items-center justify-center text-primary rounded-md'>SELECTED</div>
                </div> :
                <div className='flex items-center gap-x-2'>
