...
const ReturnOrder = ({ order }) => {
    ...
    return (
        <div>
            ...
            `}>Return {order?.report?.status}</p>
                : <button onClick={() => setReturnModal(true)} className='bg-red-500 hover:bg-red-700 px-4 py-1 rounded-full text-white text-sm'>Return</button>}
            <Modal
                title="Return Order"
                centered
                open={returnModal}
