...
const ActivateModal = () => {
    ...
    return (
        <div className={(sellerData?.data?.status === 'pending') ? 'flex items-center justify-center fixed h-screen z-50 top-0 left-0 right-0 bottom-0 bg-[rgb(0,0,0,0.5)] cursor-not-allowed' : 'hidden'}>
            <div className='bg-white lg:w-2/5 xl:w-1/3 z-50 p-10 rounded-md'>
