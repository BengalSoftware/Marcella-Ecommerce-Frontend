    ...
    return (
        <div className='rounded-lg bg-white'>
            ...
            <ul className='p-5'>
                ...
                <li><Link href='/seller' className='hover:bg-[#f5f5f5] border-b w-full p-2 hover:rounded flex font-light items-center gap-4'><AiOutlineShoppingCart /> Products</Link></li>
